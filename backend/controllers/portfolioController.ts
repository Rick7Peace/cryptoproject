 ...
 */
export const addToPortfolio = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const userId = req.user.id;
 ...
 */
export const updateHolding = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const userId = req.user.id;
    const { coinId } = req.params;
    const { quantity, purchasePrice } = req.body;
 ...
 */
export const removeFromPortfolio = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const userId = req.user.id;
    const { coinId } = req.params;
